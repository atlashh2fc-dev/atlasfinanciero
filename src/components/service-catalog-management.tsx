...
type CatalogItem = { id?: string; name: string; category: string | null; description: string | null; unit_name: string; unit_price: number; currency: "CLP" | "USD" | "UF"; is_active: boolean };
