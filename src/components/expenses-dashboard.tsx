...
const isSettled = (item: Pick<Payable, "payment_status">) => { const status = normal(item.payment_status); return status.includes("pagada") || status.includes("liquidada") || status.includes("anulada") || status.includes("nota de crédito") || status.includes("nota de credito"); };
