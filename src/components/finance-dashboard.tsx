...
const modulePreviews: Record<Module, string> = {
  ...
  "Provisiones de remuneraciones": "Estimación mensual con versiones semanales, componentes adicionales, contabilización incremental y comparación contra la nómina real.",
  "Centros de costo":
...
const navigationGroups: NavigationGroup[] = [
  ...
  },
  {
    ...
    items: ["Remuneraciones", "Provisiones de remuneraciones", "Aprobaciones", "Cierre financiero", "Administración", "Bitácora de actividad", "Control SaaS"],
    accent: "#f4a7bd",
    accentSoft: "#472b3b",
  },
];
    ...
    .map((group) => ({
      ...
      items: group.items.filter(
        (item) =>
          ...
          (item !== "Provisiones de remuneraciones" || canReadExpenses) &&
          (item !== "Reportes" || canReadExpenses) &&
      ...
      <section className="content-area">
        ...
        {activeModule === "Gestión 360" ? (
          ...
          <PayrollDashboard
            ...
            canSynchronize={access?.membership.role === "administrator"}
          />
        ) : activeModule === "Provisiones de remuneraciones" ? (
          ...
          canReadExpenses ? <ReportsDashboard
            organizationId={access?.membership.organizationId ?? null}
          /> : null
