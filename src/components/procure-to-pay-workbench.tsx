...
type Payload = { purchaseRequests: PurchaseRequest[]; purchaseOrders: PurchaseOrder[]; paymentBatches: PaymentBatch[]; paymentBatchItems: PaymentItem[]; receivedDocuments: Document[]; directPayables: DirectPayable[]; suppliers: Supplier[]; bankAccounts: Account[] };
