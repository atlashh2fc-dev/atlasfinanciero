...
- Provisiones de remuneraciones parte desde la base contractual de PeopleWork, permite incorporar supuestos manuales y conserva versiones semanales. Cada versión contabilizada registra sólo la diferencia contra la anterior; cuando existe nómina oficial, el módulo muestra la desviación y permite contabilizar el ajuste final.
